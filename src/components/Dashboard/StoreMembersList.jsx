...
export default function StoreMembersList({
  ...
  if (loading) {
    return (
      <div className="flex max-h-[85vh] w-full flex-col rounded-3xl border border-white/10 bg-slate-950 p-6 shadow-2xl">
  ...
  return (
    <div className="flex max-h-[85vh] w-full flex-col overflow-hidden rounded-3xl border border-white/10 bg-slate-950 p-4 shadow-2xl sm:p-6">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain py-4 pr-1 sm:pr-2">
        {error && (
