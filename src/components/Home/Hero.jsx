  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden bg-slate-950 px-8 pt-24 pb-0 sm:px-12 sm:pt-28 sm:pb-0">
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center gap-7 text-center">
        <span className="inline-flex rounded-full border border-white/10 bg-white/10 px-6 py-2 text-sm font-semibold uppercase tracking-[0.45em] text-slate-200/80 shadow-[0_0_60px_rgba(255,255,255,0.06)] backdrop-blur-md">Smart inventory for small business</span>
        <h1 className="max-w-4xl text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">Smart inventory and restock planning for small businesses.</h1>
