...
export default function BarcodeCenter() {
  ...
  useEffect(() => {
    ...
    scanner.render(
      ...
      () => {
        // Ignore repeated scan errors while camera is running.
      }
    );
      ...
      <div className="mx-auto max-w-7xl space-y-8">
        <div className="border-b border-white/10 pb-6">
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-400">
            Generate printable product barcodes and scan them
            using a phone or computer camera.
          </p>
        </div>
          ...
          <section className="rounded-3xl border border-white/10 bg-white/[0.02] p-6 shadow-2xl">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-slate-400">
                Select a product to view and print its barcode.
              </p>
            </div>
          ...
          <section className="rounded-3xl border border-white/10 bg-white/[0.02] p-6 shadow-2xl">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-slate-400">
                ...
                barcode from your screen or a printed label.
              </p>
            </div>
